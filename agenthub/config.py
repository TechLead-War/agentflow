...
GLOBAL_DIR = Path.home() / ".agenthub"
GLOBAL_CONFIG = GLOBAL_DIR / "config.yaml"
PROJECT_CONFIG = ".agenthub.yaml"
...
def ensure_global_dir():
    """Create ~/.agenthub/ and default config if they don't exist."""
